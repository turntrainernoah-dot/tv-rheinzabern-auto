...
- GitHub Actions sind in den **privaten** Repos bis zum **1. September 2026** blockiert (Monatskontingent aufgebraucht, kein Zahlungsproblem). **Deployen geht trotzdem jederzeit** — ueber den Workflow "Website deployen" im oeffentlichen Repo `tv-rheinzabern-auto`, siehe Abschnitt 5. Wer hier liest "Deploy geht gerade nicht", irrt: Der Weg wurde am 25.08.2026 real getestet.
